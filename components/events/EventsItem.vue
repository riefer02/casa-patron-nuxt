<template>
  <div class="max-w-full shadow-lg rounded overflow-hidden m-4 sm:flex">
    <div
      class="h-40 sm:h-auto sm:w-48 md:w-64 xl:w-1/3 flex-none bg-cover bg-center rounded rounded-t sm:rounded sm:rounded-l sm:rounded-r-none md:rounded-r-none xl:rounded-b-none rounded-b-none text-center overflow-hidden shadow-lg"
    ...
    >
      <div>
        <h2 class="mb-2 text-4xl font-light">{{ item.title }}</h2>
